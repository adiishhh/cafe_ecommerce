...
urlpatterns = [
    ...
    path("profile/security/change-email/verify/", views.verify_change_email, name="verify_change_email"),
    path("profile/security/change-email/resend/", views.resend_change_email_otp, name="resend_change_email_otp"),
